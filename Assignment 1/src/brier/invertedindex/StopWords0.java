...
public class StopWords0 extends Configured implements Tool {
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new StopWords0(), args);
   ...
   public int run(String[] args) throws Exception {	    	  
	  ...
	  Job job = new Job(getConf(), "StopWords0");
      ...
      job.setJarByClass(StopWords0.class);
