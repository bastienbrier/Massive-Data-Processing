...
public class StopWords1 extends Configured implements Tool {
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new StopWords1(), args);
   ...
   public int run(String[] args) throws Exception {	    
	  ...
	  Job job = new Job(getConf(), "StopWords1");
      ...
      job.setJarByClass(StopWords1.class);
